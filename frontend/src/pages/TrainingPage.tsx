...
export function TrainingPage() {
  ...
  const { data: sessions, isLoading } = useTrainingWeek(weekStart)
  ...
  if (isLoading || !sessions) return <p style={{ color: 'var(--text-secondary)' }}>Caricamento…</p>

  return (
    <>
      <h1 style={{ fontSize: 'var(--fs-heading)', margin: '4px 0 8px' }}>Allenamenti della settimana</h1>
